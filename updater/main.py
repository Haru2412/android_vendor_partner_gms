...
update_if_needed('LocalWifiNlpBackend', fdroid_recommended_release(fdroid_main_repo, 'org.fitchfamily.android.wifi_backen'))
update_if_needed('DejaVuNLPBackend', fdroid_recommended_release(fdroid_main_repo, 'org.fitchfamily.android.dejavu'))
